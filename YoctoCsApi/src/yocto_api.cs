...
namespace YoctoCsApi {
    ...
    public class YFunction {
        ...
        private static Dictionary<string, YDataStream> _dataStreams = new Dictionary<string, YDataStream>();
        ...
        protected byte[] _request(byte[] request) {
            ...
            if (YAPI.YISERR(res)) { // Check if an update of the device list does notb solve the issue
                res = YAPI.yapiUpdateDeviceList(1, ref errmsg);
                if (YAPI.YISERR(res)) {
                    _throw(res, errmsg);
                    return new byte[0];
        ...
        public YFUN_DESCR functionDescriptor() { return get_functionDescriptor(); }
        ...
        public object userData() { return get_userData(); }
        ...
        public void setUserData(object data) { set_userData(data); }
    ...
    public class YModule : YFunction {
        ...
        public virtual byte[] _flattenJsonStruct(byte[] jsoncomplex) {
            ...
            res = YAPI._yapiGetAllJsonKeys(new StringBuilder(jsoncomplexstr), smallbuff, 1024, ref fullsize, errmsg);
            if (res < 0) {
